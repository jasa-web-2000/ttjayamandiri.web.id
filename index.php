  ...
  <main class="overflow-x-hidden">
    ...
    <section class="container">
      <div
        ...
        <div
          class="absolute rounded-lg inset-0 bg-[radial-gradient(rgb(15_23_42_/_0.8),rgb(51_65_85_/_0.9))] from-10% via-50% to-100%">
        </div>
        <div
          ...
          <div class="md:!col-span-7 p-5 md:p-10 md:-top-10 lg:p-20 z-10">
            ...
            <p class="text-slate-300 mt-3"><?= $brand ?> merupakan agen tiket Madegondo Sukoharjo yang terdaftar KEMENKUMHAM.<br>
              NO: AHU-067566. AH.01.30.TAHUN 2023
            </p>
          ...
          <div class="col-span-full md:!col-span-1  ">
            <div class="inner-container">
              ...
              <ul class="!list-item !list-disc text-slate-300 ml-5">
                ...
                <li>Layanan Tranportasi Jawa Kalimantan</li>
              </ul>
            </div>
          </div>
          <div class="col-span-full md:!col-span-1  ">
